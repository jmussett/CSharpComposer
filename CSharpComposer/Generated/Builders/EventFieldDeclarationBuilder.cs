...
public partial interface IEventFieldDeclarationBuilder : IAddAttribute<IEventFieldDeclarationBuilder>
{
    IEventFieldDeclarationBuilder AddModifierToken(SyntaxToken modifier);
}
